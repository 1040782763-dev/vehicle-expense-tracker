...
const payment = {
  list(filters = {}) {
    ...
    result.sort((a, b) => (b.in_date || b.payment_date || '').localeCompare(a.in_date || a.payment_date || '') || b.id - a.id);
    return result.slice(0, 500);
  },
...
const invoice = {
  ...
  update(id, d) {
    ...
    if (!inv) return null;
    const fields = ['plate', 'customer', 'date', 'remark', 'vat_amount'];
